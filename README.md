...
- **Lightweight**: ~2.5MB static binary, pure Rust, no runtime dependencies
...
> [!NOTE]
> To gather Cloudflare API Token: Dashboard > Profile > API Tokens > Create Token > Choose "Edit Zone DNS" template > Zone Resources(Specific or All zone), for Specific zones choose your domain > Scroll down, Continue to summary > Create token

> [!NOTE]
> To gather your Domain Zone ID: Dashboard > Web/zones > choose your domain > scroll down, API portion of the page
...
|----------|---------------|-------|
| Linux (musl) | x86_64, arm, aarch64 | Fully static, runs anywhere |
...
This project uses [Just](https://github.com/casey/just#installation) as a command runner.
...
This installs: rustfmt, clippy, rust-analyzer, cargo-watch, cargo-tarpaulin, cargo-audit, cargo-outdated, cargo-zigbuild
